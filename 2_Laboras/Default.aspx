...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <p>&nbsp;</p>
    <p>
        <asp:Button ID="Button1" runat="server" CommandName="Groju" Text="►" OnCommand="Bendras" />
        <asp:Button ID="Button2" runat="server" CommandName="Pauze" Text="▌▌" OnCommand="Bendras" />
        <asp:Button ID="Button3" runat="server" CommandName="Stop" Text="■" OnCommand="Bendras" />
    </p>
    <p>&nbsp;</p>
    <ol class="round">
        <li class="one">
