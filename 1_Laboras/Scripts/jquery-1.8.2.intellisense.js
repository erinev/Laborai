...
intellisense.annotate(jQuery, {
    'ajax': function() {
        ...
        ///         A set of key/value pairs that configure the Ajax request. All settings are
        ///         optional. A default can be set for any option with $.ajaxSetup(). See jQuery.ajax( settings ) below for a
        ...
        ///     <param name="settings" type="Object">
        ///         A set of key/value pairs that configure the Ajax request. All settings are
        ///         optional. A default can be set for any option with $.ajaxSetup().
        ///     </param>
        ///     <returns type="jqXHR" />
        /// </signature>
    },
    'ajaxPrefilter': function() {
        ...
        ///     <param name="handler(options, originalOptions, jqXHR)" type="Function">
        ///         A handler to set default values for future
        ///         Ajax requests.
        ///     </param>
        /// </signature>
    },
    'ajaxSetup': function() {
        ...
        ///         A set of key/value pairs that configure the default Ajax request. All options
        ///         are optional.
        ///     </param>
        /// </signature>
    },
    'boxModel': function() {
        /// <summary>
        ///     Deprecated in jQuery 1.3 (see jQuery.support). States if the current page, in the user's browser, is being
        ///     rendered using the W3C CSS Box Model.
        /// </summary>
        /// <returns type="Boolean" />
    },
    'browser': function() {
        /// <summary>
        ///     Contains flags for the useragent, read from navigator.userAgent. We recommend against using this property;
        ///     please try to use feature detection instead (see jQuery.support). jQuery.browser may be moved to a plugin in a
    ...
    'Callbacks': function() {
        ...
        ///         An optional list of space-separated flags that change how the callback list
        ///         behaves.
        ///     </param>
        /// </signature>
    },
    ...
    'cssHooks': function() {
        /// <summary>
        ///     Hook directly into jQuery to override how particular CSS properties are retrieved or set, normalize CSS
        ///     property naming, or create custom properties.
        /// </summary>
        /// <returns type="Object" />
    },
    'data': function() {
        /// <signature>
        ///     <summary>
        ///         Returns value at named data store for the element, as set by jQuery.data(element, name, value), or the
        ///         full data store for the element.
        ///     </summary>
    ...
    'dequeue': function() {
        ...
        ///         A string containing the name of the queue. Defaults to fx, the standard
        ///         effects queue.
        ///     </param>
        /// </signature>
    },
    'each': function() {
        /// <signature>
        ///     <summary>
        ///         A generic iterator function, which can be used to seamlessly iterate over both objects and arrays. Arrays
        ///         and array-like objects with a length property (such as a function's arguments object) are iterated by numeric
        ///         index, from 0 to length-1. Other objects are iterated via their named properties.
        ///     </summary>
        ///     <param name="collection" type="Object">The object or array to iterate over.</param>
        ///     <param name="callback(indexInArray, valueOfElement)" type="Function">
        ///         The function that will be executed on every
        ///         object.
        ///     </param>
        ///     <returns type="Object" />
        /// </signature>
    ...
    'extend': function() {
        ...
        ///         An object that will receive the new properties if additional objects are passed
    ...
    'get': function() {
        ...
        ///     <param name="success(data, textStatus, jqXHR)" type="Function">
        ///         A callback function that is executed if the request
        ///         succeeds.
        ///     </param>
        ///     <param name="dataType" type="String">
        ///         The type of data expected from the server. Default: Intelligent Guess (xml,
        ///         json, script, or html).
        ///     </param>
        ///     <returns type="jqXHR" />
        /// </signature>
    ...
    'getScript': function() {
        ...
        ///     <param name="url" type="String">A string containing the URL to which the request is sent.</param>
        ///     <param name="success(script, textStatus, jqXHR)" type="Function">
        ///         A callback function that is executed if the
        ///         request succeeds.
        ///     </param>
        ///     <returns type="jqXHR" />
        /// </signature>
    ...
    'grep': function() {
        ...
        ///         The first argument to the function is the item, and the second argument is the index.  The function should
        ///         return a Boolean value.  this will be the global window object.
        ///     </param>
        ///     <param name="invert" type="Boolean">
        ///         If "invert" is false, or not provided, then the function returns an array
        ///         consisting of all elements for which "callback" returns true.  If "invert" is true, then the function returns
    ...
    'inArray': function() {
        ...
        ///         The index of the array at which to begin the search. The default is 0, which
        ///         will search the whole array.
        ///     </param>
        ///     <returns type="Number" />
        /// </signature>
    },
    ...
    'map': function() {
        ...
        ///     <param name="callback(elementOfArray, indexInArray)" type="Function">
        ///         The function to process each item against.
        ///         The first argument to the function is the array item, the second argument is the index in array The function
        ///         can return any value. Within the function, this refers to the global (window) object.
        ///     </param>
        ///     <returns type="Array" />
        /// </signature>
        /// <signature>
        ...
        ///     <param name="callback( value, indexOrKey )" type="Function">
        ///         The function to process each item against.  The first
        ///         argument to the function is the value; the second argument is the index or key of the array or object property.
        ///         The function can return any value to add to the array. A returned array will be flattened into the resulting
        ///         array. Within the function, this refers to the global (window) object.
        ///     </param>
        ///     <returns type="Array" />
        /// </signature>
    },
    ...
    'noConflict': function() {
        ...
        ///         A Boolean indicating whether to remove all jQuery variables from the global
    ...
    'param': function() {
        ...
        ///         A Boolean indicating whether to perform a traditional "shallow"
        ///         serialization.
        ///     </param>
        ///     <returns type="String" />
        /// </signature>
    ...
    'proxy': function() {
        ...
        ///         The name of the function whose context will be changed (should be a property of
        ///         the context object).
        ///     </param>
        ///     <returns type="Function" />
        /// </signature>
    ...
    'sub': function() {
        /// <summary>
        ///     Creates a new copy of jQuery whose properties and methods can be modified without affecting the original
        ///     jQuery object.
        /// </summary>
        /// <returns type="jQuery" />
    },
    'support': function() {
        /// <summary>
        ///     A collection of properties that represent the presence of different browser features or bugs. Primarily
        ///     intended for jQuery's internal use; specific properties may be removed when they are no longer needed internally to
    ...
    'unique': function() {
        ...
        ///         of DOM elements, not strings or numbers.
        ///     </summary>
...
jQuery.Callbacks = function(flags) {
    ...
    intellisense.annotate(_object, {
        'add': function() {
            ...
            ///         A function, or array of functions, that are to be added to the callback
            ///         list.
            ///     </param>
            /// </signature>
        },
        ...
        'remove': function() {
            ...
            ///     <param name="callbacks" type="Function">
            ///         A function, or array of functions, that are to be removed from the callback
            ///         list.
            ///     </param>
            /// </signature>
        },
...
jQuery.Deferred = function(func) {
    ...
    intellisense.annotate(_object, {
        'always': function() {
            ...
            ///     <param name="alwaysCallbacks" type="Function">
        ...
        'done': function() {
            ...
            ///         A function, or array of functions, that are called when the Deferred is
            ///         resolved.
            ///     </param>
            ///     <param name="doneCallbacks" type="Function">
            ///         Optional additional functions, or arrays of functions, that are called
        ...
        'pipe': function() {
            ...
            ///     <param name="doneFilter" type="Function">An optional function that is called when the Deferred is resolved.</param>
            ///     <param name="failFilter" type="Function">An optional function that is called when the Deferred is rejected.</param>
            ///     <param name="progressFilter" type="Function">
        ...
        'progress': function() {
            ...
            ///     <param name="progressCallbacks" type="Function">
            ///         A function, or array of functions, that is called when the Deferred
        ...
        'then': function() {
            ...
            ///     </param>
            ///     <param name="progressCallbacks" type="Function">
            ///         A function, or array of functions, called when the Deferred
            ///         notifies progress.
            ///     </param>
            ///     <returns type="Deferred" />
            /// </signature>
...
intellisense.annotate(jQuery.Event.prototype, {
    ...
    'stopPropagation': function() {
        /// <summary>
        ///     Prevents the event from bubbling up the DOM tree, preventing any parent handlers from being notified of the
        ///     event.
        /// </summary>
    },
    'target': function() {
...
intellisense.annotate(jQuery.fn, {
    'add': function() {
        ...
        ///         A string representing a selector expression to find additional elements to add
        ...
        ///         The point in the document at which the selector should begin matching; similar
        ///         to the context argument of the $(selector, context) method.
        ///     </param>
        ///     <returns type="jQuery" />
        /// </signature>
    },
    'addClass': function() {
        ...
        /// <signature>
        ///     <summary>Adds the specified class(es) to each of the set of matched elements.</summary>
        ///     <param name="function(index, currentClass)" type="Function">
        ///         A function returning one or more space-separated class
        ///         names to be added to the existing class name(s). Receives the index position of the element in the set and the
        ///         existing class name(s) as arguments. Within the function, this refers to the current element in the set.
        ///     </param>
        ///     <returns type="jQuery" />
        /// </signature>
    },
    'after': function() {
        ...
        ///         HTML string, DOM element, or jQuery object to insert after each element in the
        ///         set of matched elements.
        ///     </param>
        ///     <param name="content" type="jQuery">
        ///         One or more additional DOM elements, arrays of elements, HTML strings, or
        ...
        /// <signature>
        ///     <summary>Insert content, specified by the parameter, after each element in the set of matched elements.</summary>
        ///     <param name="function(index)" type="Function">
        ///         A function that returns an HTML string, DOM element(s), or jQuery
        ///         object to insert after each element in the set of matched elements. Receives the index position of the element
        ///         in the set as an argument. Within the function, this refers to the current element in the set.
        ///     </param>
        ///     <returns type="jQuery" />
        /// </signature>
    },
    ...
    'animate': function() {
        ...
        ///         duration: A string or number determining how long the animation will run.easing: A string indicating which
        ///         easing function to use for the transition.complete: A function to call once the animation is complete.step: A
        ///         function to be called after each step of the animation.queue: A Boolean indicating whether to place the
        ///         animation in the effects queue. If false, the animation will begin immediately. As of jQuery 1.7, the queue
        ///         option can also accept a string, in which case the animation is added to the queue represented by that
        ///         string.specialEasing: A map of one or more of the CSS properties defined by the properties argument and their
        ///         corresponding easing functions (added 1.4).
        ///     </param>
        ///     <returns type="jQuery" />
        /// </signature>
    },
    ...
    'append': function() {
        ...
        ///     <param name="content" type="jQuery">
        ///         DOM element, HTML string, or jQuery object to insert at the end of each element
        ...
        /// <signature>
        ///     <summary>Insert content, specified by the parameter, to the end of each element in the set of matched elements.</summary>
        ///     <param name="function(index, html)" type="Function">
        ///         A function that returns an HTML string, DOM element(s), or
        ///         jQuery object to insert at the end of each element in the set of matched elements. Receives the index position
        ///         of the element in the set and the old HTML value of the element as arguments. Within the function, this refers
    ...
    'appendTo': function() {
        ...
        ///         A selector, element, HTML string, or jQuery object; the matched set of elements
    ...
    'attr': function() {
        ...
        ///     <summary>Set one or more attributes for the set of matched elements.</summary>
        ///     <param name="attributeName" type="String">The name of the attribute to set.</param>
        ///     <param name="function(index, attr)" type="Function">
        ///         A function returning the value to set. this is the current
        ///         element. Receives the index position of the element in the set and the old attribute value as arguments.
        ///     </param>
        ///     <returns type="jQuery" />
        /// </signature>
    },
    ...
    'attributeContainsPrefix': function() {
        /// <signature>
        ///     <summary>
        ///         Selects elements that have the specified attribute with a value either equal to a given string or starting
        ///         with that string followed by a hyphen (-).
        ///     </summary>
        ///     <param name="attribute" type="String">An attribute name.</param>
        ///     <param name="value" type="String">An attribute value. Can be either an unquoted single word or a quoted string.</param>
        /// </signature>
    ...
    'attributeContainsWord': function() {
        /// <signature>
        ///     <summary>
        ///         Selects elements that have the specified attribute with a value containing a given word, delimited by
        ///         spaces.
        ///     </summary>
        ///     <param name="attribute" type="String">An attribute name.</param>
        ///     <param name="value" type="String">An attribute value. Can be either an unquoted single word or a quoted string.</param>
    ...
    'attributeNotEqual': function() {
        /// <signature>
        ///     <summary>
        ///         Select elements that either don't have the specified attribute, or do have the specified attribute but not
    ...
    'before': function() {
        ...
        ///     <param name="content" type="jQuery">
        ///         HTML string, DOM element, or jQuery object to insert before each element in the
        ///         set of matched elements.
        ///     </param>
        ///     <param name="content" type="jQuery">
        ///         One or more additional DOM elements, arrays of elements, HTML strings, or
        ...
        ///         A function that returns an HTML string, DOM element(s), or jQuery object to
        ///         insert before each element in the set of matched elements. Receives the index position of the element in the
    ...
    'bind': function() {
        ...
        ///         A string containing one or more DOM event types, such as "click" or "submit,"
        ...
        ///     </param>
        ///     <param name="eventData" type="Object">A map of data that will be passed to the event handler.</param>
        ///     <param name="preventBubble" type="Boolean">
        ///         Setting the third argument to false will attach a function that prevents
        ///         the default action from occurring and stops the event from bubbling. The default is true.
        ///     </param>
        ///     <returns type="jQuery" />
        /// </signature>
        /// <signature>
    ...
    'class': function() {
        ...
        ///         A class to search for. An element can have multiple classes; only one of them
        ///         must match.
        ///     </param>
        /// </signature>
    },
    ...
    'clone': function() {
        ...
        ///     <param name="withDataAndEvents" type="Boolean">
        ///         A Boolean indicating whether event handlers should be copied along
        ///         with the elements. As of jQuery 1.4, element data will be copied as well.
        ///     </param>
        ///     <returns type="jQuery" />
        /// </signature>
        /// <signature>
        ...
        ///         copied along with the elements. The default value is false. *In jQuery 1.5.0 the default value was incorrectly
        ///         true; it was changed back to false in 1.5.1 and up.
        ///     </param>
        ///     <param name="deepWithDataAndEvents" type="Boolean">
        ///         A Boolean indicating whether event handlers and data for all
        ///         children of the cloned element should be copied. By default its value matches the first argument's value (which
        ///         defaults to false).
        ///     </param>
        ///     <returns type="jQuery" />
        /// </signature>
    ...
    'closest': function() {
        /// <signature>
        ///     <summary>
        ///         Get the first element that matches the selector, beginning at the current element and progressing up
        ...
        ///     <param name="selector" type="String">A string containing a selector expression to match elements against.</param>
        ///     <param name="context" type="Element">
        ///         A DOM element within which a matching element may be found. If no context is
    ...
    'context': function() {
        /// <summary>
        ///     The DOM node context originally passed to jQuery(); if none was passed then context will likely be the
        ///     document.
        /// </summary>
        /// <returns type="Element" />
    },
    'css': function() {
        ...
        ///     <summary>Set one or more CSS properties for the  set of matched elements.</summary>
        ///     <param name="propertyName" type="String">A CSS property name.</param>
        ///     <param name="function(index, value)" type="Function">
        ///         A function returning the value to set. this is the current
        ///         element. Receives the index position of the element in the set and the old value as arguments.
        ///     </param>
        ///     <returns type="jQuery" />
        /// </signature>
        /// <signature>
    ...
    'delay': function() {
        ...
        ///         An integer indicating the number of milliseconds to delay execution of the
    ...
    'delegate': function() {
        ...
        ///     <param name="eventType" type="String">
        ///         A string containing one or more space-separated JavaScript event types, such
        ///         as "click" or "keydown," or custom event names.
        ///     </param>
    ...
    'die': function() {
        ...
        /// <signature>
        ///     <summary>Remove an event handler previously attached using .live() from the elements.</summary>
        ///     <param name="eventTypes" type="Object">
        ///         A map of one or more event types, such as click or keydown and their
    ...
    'eq': function() {
        ...
        ///         An integer indicating the position of the element, counting backwards  from the
    ...
    'filter': function() {
        ...
        ///     <param name="selector" type="String">
        ///         A string containing a selector expression to match the current set of elements
        ///         against.
        ///     </param>
        ///     <returns type="jQuery" />
        /// </signature>
    ...
    'height': function() {
        ...
        ///         An integer representing the number of pixels, or an integer with an optional unit
        ///         of measure appended (as a string).
        ///     </param>
        ///     <returns type="jQuery" />
        /// </signature>
        /// <signature>
        ///     <summary>Set the CSS height of every matched element.</summary>
        ///     <param name="function(index, height)" type="Function">
        ///         A function returning the height to set. Receives the index
        ///         position of the element in the set and the old height as arguments. Within the function, this refers to the
    ...
    'hover': function() {
        /// <signature>
        ///     <summary>
        ///         Bind two handlers to the matched elements, to be executed when the mouse pointer enters and leaves the
        ///         elements.
        ///     </summary>
        ///     <param name="handlerIn(eventObject)" type="Function">
        ///         A function to execute when the mouse pointer enters the
        ///         element.
        ///     </param>
        ///     <param name="handlerOut(eventObject)" type="Function">
        ///         A function to execute when the mouse pointer leaves the
        ///         element.
        ///     </param>
        ///     <returns type="jQuery" />
        /// </signature>
    ...
    'html': function() {
        ...
        /// <signature>
        ///     <summary>Set the HTML contents of each element in the set of matched elements.</summary>
        ///     <param name="function(index, oldhtml)" type="Function">
        ///         A function returning the HTML content to set. Receives the
        ///         index position of the element in the set and the old HTML value as arguments. jQuery empties the element before
        ///         calling the function; use the oldhtml argument to reference the previous content. Within the function, this
    ...
    'innerHeight': function() {
        /// <summary>
        ///     Get the current computed height for the first element in the set of matched elements, including padding but
        ///     not border.
        /// </summary>
    ...
    'innerWidth': function() {
        /// <summary>
        ///     Get the current computed width for the first element in the set of matched elements, including padding but not
        ///     border.
        /// </summary>
        /// <returns type="Integer" />
    },
    ...
    'is': function() {
        ...
        ///         argument, index, which is the element's index in the jQuery collection.Within the function, this refers to the
        ///         current DOM element.
        ///     </param>
        ///     <returns type="Boolean" />
        /// </signature>
    ...
    'live': function() {
        ...
        ///         A string containing a JavaScript event type, such as "click" or "keydown." As of
        ///         jQuery 1.4 the string can contain multiple, space-separated event types or custom event names.
        ///     </param>
        ///     <param name="handler(eventObject)" type="Function">A function to execute at the time the event is triggered.</param>
        ///     <returns type="jQuery" />
        /// </signature>
        ...
        /// <signature>
        ///     <summary>Attach an event handler for all elements which match the current selector, now and in the future.</summary>
        ///     <param name="events-map" type="Object">
        ///         A map of one or more JavaScript event types and functions to execute for
        ///         them.
        ///     </param>
        ///     <returns type="jQuery" />
        /// </signature>
    ...
    'map': function() {
        ...
        ///         the return values.
        ///     </summary>
        ///     <param name="callback(index, domElement)" type="Function">
    ...
    'next siblings': function() {
        /// <signature>
        ///     <summary>
        ///         Selects all sibling elements that follow after the "prev" element, have the same parent, and match the
        ///         filtering "siblings" selector.
        ///     </summary>
        ///     <param name="prev" type="String">Any valid selector.</param>
        ///     <param name="siblings" type="String">
        ///         A selector to filter elements that are the following siblings of the first
        ///         selector.
        ///     </param>
        /// </signature>
    },
    ...
    'nextUntil': function() {
        ...
        ///     </summary>
        ///     <param name="selector" type="String">
        ///         A string containing a selector expression to indicate where to stop matching
        ...
        ///         A DOM node or jQuery object indicating where to stop matching following
        ///         sibling elements.
        ///     </param>
        ///     <param name="filter" type="String">A string containing a selector expression to match elements against.</param>
        ///     <returns type="jQuery" />
    ...
    'nth-child': function() {
        ...
        ///         The index of each child to match, starting with 1, the string even or odd, or an
        ///         equation ( eg. :nth-child(even), :nth-child(4n) )
        ///     </param>
        /// </signature>
    },
    'odd': function() {
    ...
    'off': function() {
        ...
        ///     <param name="events" type="String">
        ///         One or more space-separated event types and optional namespaces, or just
        ...
        ///     </param>
        ///     <param name="handler(eventObject)" type="Function">
        ...
        ///     <summary>Remove an event handler.</summary>
        ///     <param name="events-map" type="Object">
        ///         A map where the string keys represent one or more space-separated event
        ///         types and optional namespaces, and the values represent handler functions previously attached for the event(s).
        ///     </param>
        ///     <param name="selector" type="String">
        ///         A selector which should match the one originally passed to .on() when
        ///         attaching event handlers.
    ...
    'offset': function() {
        ...
        /// <signature>
        ///     <summary>Set the current coordinates of every element in the set of matched elements, relative to the document.</summary>
        ///     <param name="function(index, coords)" type="Function">
        ///         A function to return the coordinates to set. Receives the
        ///         index of the element in the collection as the first argument and the current coordinates as the second
        ///         argument. The function should return an object with the new top and left properties.
        ///     </param>
        ///     <returns type="jQuery" />
        /// </signature>
    },
    ...
    'on': function() {
        ...
        ///         trigger the event. If the selector is null or omitted, the event is always triggered when it reaches the
        ///         selected element.
        ///     </param>
        ...
        ///     <summary>Attach an event handler function for one or more events to the selected elements.</summary>
        ///     <param name="events-map" type="Object">
        ///         A map in which the string keys represent one or more space-separated event
        ///         types and optional namespaces, and the values represent a handler function to be called for the event(s).
        ///     </param>
        ///     <param name="selector" type="String">
        ///         A selector string to filter the descendants of the selected elements that will
        ///         call the handler. If the selector is null or omitted, the handler is always called when it reaches the selected
        ///         element.
        ///     </param>
    ...
    'one': function() {
        ...
        ///     <param name="events" type="String">
        ///         A string containing one or more JavaScript event types, such as "click" or
    ...
    'outerHeight': function() {
        ...
        ///         border, and optionally margin. Returns an integer (without "px") representation of the value or null if called
        ///         on an empty set of elements.
        ///     </summary>
        ///     <param name="includeMargin" type="Boolean">
    ...
    'outerWidth': function() {
        /// <signature>
        ///     <summary>
        ///         Get the current computed width for the first element in the set of matched elements, including padding and
        ///         border.
        ///     </summary>
        ///     <param name="includeMargin" type="Boolean">
        ///         A Boolean indicating whether to include the element's margin in the
    ...
    'parentsUntil': function() {
        ...
        ///     </summary>
        ///     <param name="element" type="Element">
        ///         A DOM node or jQuery object indicating where to stop matching ancestor
        ///         elements.
        ///     </param>
        ///     <param name="filter" type="String">A string containing a selector expression to match elements against.</param>
        ///     <returns type="jQuery" />
    ...
    'position': function() {
        /// <summary>
        ///     Get the current coordinates of the first element in the set of matched elements, relative to the offset
        ///     parent.
        /// </summary>
        /// <returns type="Object" />
    },
    'prepend': function() {
        ...
        ///     </summary>
        ///     <param name="content" type="jQuery">
        ///         DOM element, array of elements, HTML string, or jQuery object to insert at the
        ...
        ///     <param name="function(index, html)" type="Function">
        ///         A function that returns an HTML string, DOM element(s), or
        ///         jQuery object to insert at the beginning of each element in the set of matched elements. Receives the index
        ///         position of the element in the set and the old HTML value of the element as arguments. Within the function,
    ...
    'prevUntil': function() {
        ...
        ///     </summary>
        ///     <param name="element" type="Element">
        ///         A DOM node or jQuery object indicating where to stop matching preceding
        ///         sibling elements.
        ///     </param>
        ///     <param name="filter" type="String">A string containing a selector expression to match elements against.</param>
        ///     <returns type="jQuery" />
    ...
    'promise': function() {
        /// <signature>
        ///     <summary>
        ///         Return a Promise object to observe when all actions of a certain type bound to the collection, queued or
        ///         not, have finished.
        ///     </summary>
    ...
    'prop': function() {
        ...
        ///     <summary>Set one or more properties for the set of matched elements.</summary>
        ///     <param name="propertyName" type="String">The name of the property to set.</param>
        ///     <param name="function(index, oldPropertyValue)" type="Function">
        ///         A function returning the value to set. Receives the
        ///         index position of the element in the set and the old property value as arguments. Within the function, the
        ///         keyword this refers to the current element.
        ///     </param>
        ///     <returns type="jQuery" />
        /// </signature>
    },
    ...
    'queue': function() {
        ...
        ///         effects queue.
        ///     </param>
        ///     <param name="callback( next )" type="Function">
    ...
    'removeAttr': function() {
        ...
        ///         An attribute to remove; as of version 1.7, it can be a space-separated
        ///         list of attributes.
        ///     </param>
        ///     <returns type="jQuery" />
        /// </signature>
    ...
    'removeClass': function() {
        ...
        /// <signature>
        ///     <summary>Remove a single class, multiple classes, or all classes from each element in the set of matched elements.</summary>
        ///     <param name="function(index, class)" type="Function">
        ///         A function returning one or more space-separated class names
        ///         to be removed. Receives the index position of the element in the set and the old class value as arguments.
        ///     </param>
        ///     <returns type="jQuery" />
        /// </signature>
    },
    ...
    'replaceWith': function() {
        ...
        ///     <summary>Replace each element in the set of matched elements with the provided new content.</summary>
        ///     <param name="function" type="Function">
        ///         A function that returns content with which to replace the set of matched
        ///         elements.
        ///     </param>
        ///     <returns type="jQuery" />
        /// </signature>
    ...
    'slice': function() {
        ...
        ///         selected. If negative, it indicates an offset from the end of the set. If omitted, the range continues until
        ///         the end of the set.
        ///     </param>
        ///     <returns type="jQuery" />
        /// </signature>
    ...
    'stop': function() {
        ...
        ///         A Boolean indicating whether to remove queued animation as well. Defaults
        ///         to false.
        ///     </param>
    ...
    'text': function() {
        ...
        /// <signature>
        ///     <summary>Set the content of each element in the set of matched elements to the specified text.</summary>
        ///     <param name="function(index, text)" type="Function">
        ///         A function returning the text content to set. Receives the
        ///         index position of the element in the set and the old text value as arguments.
        ///     </param>
        ///     <returns type="jQuery" />
        /// </signature>
    },
    ...
    'toggleClass': function() {
        ...
        ///     </summary>
        ///     <param name="className" type="String">
        ///         One or more class names (separated by spaces) to be toggled for each element
        ///         in the matched set.
        ///     </param>
        ///     <returns type="jQuery" />
        /// </signature>
        ...
        ///         A Boolean (not just truthy/falsy) value to determine whether the class should
        ///         be added or removed.
        ///     </param>
        ///     <returns type="jQuery" />
        /// </signature>
        ...
        ///         the class's presence or the value of the switch argument.
        ///     </summary>
        ///     <param name="function(index, class, switch)" type="Function">
        ///         A function that returns class names to be toggled in
        ///         the class attribute of each element in the matched set. Receives the index position of the element in the set,
        ///         the old class value, and the switch as arguments.
        ///     </param>
        ///     <param name="switch" type="Boolean">A boolean value to determine whether the class should be added or removed.</param>
        ///     <returns type="jQuery" />
        /// </signature>
    ...
    'unbind': function() {
        ...
        ///     <summary>Remove a previously-attached event handler from the elements.</summary>
        ///     <param name="eventType" type="String">A string containing a JavaScript event type, such as click or submit.</param>
        ///     <param name="false" type="Boolean">
        ///         Unbinds the corresponding 'return false' function that was bound using .bind(
        ///         eventType, false ).
        ///     </param>
        ///     <returns type="jQuery" />
        /// </signature>
    ...
    'undelegate': function() {
        /// <signature>
        ///     <summary>
        ///         Remove a handler from the event for all elements which match the current selector, based upon a specific
        ...
        ///         A map of one or more event types and previously bound functions to unbind from
        ///         them.
        ///     </param>
        ///     <returns type="jQuery" />
        /// </signature>
    ...
    'val': function() {
        ...
        ///         A string of text or an array of strings corresponding to the value of each
    ...
    'width': function() {
        ...
        ///     <param name="value" type="Number">
        ///         An integer representing the number of pixels, or an integer along with an
        ...
        /// <signature>
        ///     <summary>Set the CSS width of each element in the set of matched elements.</summary>
        ///     <param name="function(index, width)" type="Function">
        ///         A function returning the width to set. Receives the index
        ///         position of the element in the set and the old width as arguments. Within the function, this refers to the
        ///         current element in the set.
        ///     </param>
        ///     <returns type="jQuery" />
        /// </signature>
    ...
    'wrap': function() {
        ...
        ///         wrap around the matched elements. Receives the index position of the element in the set as an argument. Within
    ...
    'wrapInner': function() {
        ...
        ///         content of the matched elements. Receives the index position of the element in the set as an argument. Within
        ///         the function, this refers to the current element in the set.
        ///     </param>
        ///     <returns type="jQuery" />
        /// </signature>
